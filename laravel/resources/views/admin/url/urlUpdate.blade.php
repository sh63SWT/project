    ...
    <div class="result_wrap">
        <div class="result_content">
            <div class="short_wrap">
                <a href="#"><i class="fa fa-plus"></i>新增文章</a> id
    ...
    <div class="result_wrap">
        <form action="{{url('/url-Update')}}" method="post" enctype='multipart/form-data'>
            ...
            <table class="add_tab">
                <tbody>
                <td>
                    <input type="hidden" class="mg" name="id" value="{{$url->id}}">
                </td>
                <tr>
                    <th><i class="require">*</i>友情链接</th>
                    <td>
                        <input type="text" class="mg" name="url" value="{{$url->url}}"id="url">
                    </td>
                </tr>
                <tr>
                    <th><i class="require">*</i>友情链接名</th>
                    <td>
                        <input type="text" class="mg" name="urlname" value="{{$url->urlname}}" id="name">
                    </td>
                </tr>
                <tr>
                    <th></th>
