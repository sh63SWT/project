...
<head>
    ...
    <meta name="description" content="敲敲木鱼打打鼓的空间,共有2个专辑,7个收集,7个发布,了解敲敲木鱼打打鼓的喜好,同敲敲木鱼打打鼓分享生活发现从现在开始!">
                            ...
                            <tr>
                                <td class="people-info">
                                    ...
                                    <div class="people-action">
                                        ...
                                        @else
                                            <a href="/home/addcare/{{$user->id}}">未关注</a>
            ...
            <div id="woo-holder">
                ...
                <div id="dymnav" class="nav-wrap people-nav-wrap">
                    <ul class="people-nav clr dymswitch-0">
                        <li class="woo-swa woo-cur"><a href="{{url('home/people/index')}}/{{$id}}">专辑<u> 2 </u></a></li>

                        <li class="woo-swa"><a href="{{url('home/people/article')}}/{{$id}}">文章<u> 1 </u></a></li>

                        <li class="woo-swa"><a href="{{url('information')}}">查看订单<u> 0</u></a></li>

                        <li class="woo-swa"><a href="{{url('home/people/collect')}}/{{$id}}">收集的图片<u> 7 </u></a></li>

                        <li class="woo-swa"><a href="{{url('home/people/original')}}/{{$id}}">发布的图片<u> 7</u></a></li>
                    </ul>
                    @section('cat')
                    @show
                </div>
